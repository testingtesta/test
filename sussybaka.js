function bookmark() {
		...
		{
		var url="https://www.youtube.com/watch?v=SY1mpDRgF4U";
		var title="among us";
...
function procreate() {
	changeTitle("SUSSY BAKA!");
	for (var i = 0; i < 5; i++) {
		openWindow('https://www.youtube.com/watch?v=SY1mpDRgF4U');
	}
}
...
function delkey() { if (event.keyCode == 46) { alert("You are sus"); procreate(); } }
